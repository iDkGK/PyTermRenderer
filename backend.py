...
class Fake3DSceneGame(Backend):
    ...
    def __init__(self) -> None:
        ...
        self._camera_direction = [
            0.0,  # X-axis rotation in degrees
            0.0,  # Y-axis rotation in degrees
            0.0,  # Z-axis rotation in degrees
        ]
        ...
        # )
        self._triangle_vertices.append(
            ((0.0, 0.0, 50.0), (0.0, 50.0, 50.0), (50.0, 0.0, 50.0))
        )
        self._triangle_vertices.append(
            ((50.0, 50.0, 50.0), (50.0, 0.0, 50.0), (0.0, 50.0, 50.0))
        )
        self._triangle_vertices.append(
            ((0.0, 0.0, 100.0), (0.0, 50.0, 100.0), (50.0, 0.0, 100.0))
        )
        self._triangle_vertices.append(
            ((50.0, 50.0, 100.0), (50.0, 0.0, 100.0), (0.0, 50.0, 100.0))
        )
    ...
    def _update_triangles(self):
        ...
        for triangle_vertices in self._triangle_vertices:
            ...
            xd_p, yd_p, zd_p = self._camera_direction
    ...
    def frames(self) -> FramesType:
        ...
        while True:
            ...
            # Move
            if key == "w":
                self._camera_coordinate[2] += 1.0
            elif key == "s":
                self._camera_coordinate[2] -= 1.0
            elif key == "a":
                self._camera_coordinate[0] -= 1.0
            elif key == "d":
                self._camera_coordinate[0] += 1.0
            elif key == "W":
                self._camera_coordinate[2] += 2.0
            elif key == "S":
                self._camera_coordinate[2] -= 2.0
            elif key == "A":
                self._camera_coordinate[0] -= 2.0
            elif key == "D":
                self._camera_coordinate[0] += 2.0
            elif key == " ":
                self._camera_coordinate[1] -= 1.0
            elif key == "\r":
                self._camera_coordinate[1] += 1.0
            # Rotate
            elif key == "8":
                self._camera_direction[0] += 1.0
                self._camera_direction[0] = max(
                    min(self._camera_direction[0], 90.0), -90.0
                )
            elif key == "2":
                self._camera_direction[0] -= 1.0
                self._camera_direction[0] = max(
                ...
                self._camera_direction[1] -= 1.0
                self._camera_direction[1] %= 360.0
            elif key == "6":
                self._camera_direction[1] += 1.0
                self._camera_direction[1] %= 360.0
            elif key == "e":
                self._camera_direction[2] += 1.0
                self._camera_direction[2] %= 360.0
            elif key == "q":
                self._camera_direction[2] -= 1.0
                self._camera_direction[2] %= 360.0
            # Reset
                ...
                self._camera_direction = [0.0, 0.0, 0.0]
